...
public class MapLoader 
{
    ...
    private Sprite mission2Sprite;
    private Sprite mission3Sprite;
    private Sprite mission4Sprite;
    ...
    */
    ...
    public TileMap clearMap(){
        try{
            return loadMap("maps/clear.txt");
        }
        catch (IOException ex) {
            ex.printStackTrace();
            return null;
        ...
        for (int y=0; y<height; y++) {
            ...
            for (int x=0; x<line.length(); x++) {
                ...
                // check if the char represents a sprite
                    ...
                    addSprite(newMap, missionSprite, x, y);
                }
                else if (ch == '4') {
                    addSprite(newMap, mission2Sprite, x, y);
                }
                else if (ch == '5') {
                    addSprite(newMap, mission3Sprite, x, y);
                }
                else if (ch == '6') {
                    addSprite(newMap, mission4Sprite, x, y);
                }
            }
        }

        // add the player to the map
        Sprite player1 = (Sprite)playerSprite.clone();
        Sprite player2 = (Sprite)playerSprite.clone();
        Sprite player3 = (Sprite)playerSprite.clone();
        player1.setX(TileMapDrawer.tilesToPixels(3));
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void loadCreatureSprites() 
    {
        ...
        images[1] = new Image[images[1].length];
        images[2] = new Image[images[1].length];
        images[3] = new Image[images[1].length];
        images[1] = new Image[images[2].length];
        images[2] = new Image[images[2].length];
    ...
    private Animation createPlayerAnim(Image img1, Image img2, Image img3)
    {
    ...
    private void loadPowerUpSprites() 
    {
        ...
        anim = new Animation();
        anim.addFrame(loadImage("Ka.png"),250);
        missionSprite = new PowerUp.MissionKa(anim);

        anim = new Animation();
        anim.addFrame(loadImage("Ba.png"),250);
        mission2Sprite = new PowerUp.MissionBa(anim);
        
        anim = new Animation();
        anim.addFrame(loadImage("Ya.png"),250);
        mission3Sprite = new PowerUp.MissionYa(anim);

        anim = new Animation();
        anim.addFrame(loadImage("eN.png"),250);
        mission4Sprite = new PowerUp.MissionN(anim);
    }
